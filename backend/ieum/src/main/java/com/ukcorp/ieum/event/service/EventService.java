...
public interface EventService {
    void insertEvent(EventInsertRequestDto event);
    EventGetResponseDto getEvent(Long eventNo);
    List<EventGetResponseDto> getAllEvent(Long careNo);

    void updateEvent(EventUpdateRequestDto event);
