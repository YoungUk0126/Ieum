  ...
  <div class="max-w-3xl p-6">
    ...
    <div class="mb-40 ml-6 mr-2">
      <div id="ID" class="mt-6">
        <label for="ID" class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >아이디</label
        >
        <div class="grid grid-cols-6 gap-4">
          <div class="col-span-4">
            <input
              type="text"
              class="text-xl bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div id="name" class="mt-8">
        <label for="name" class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >이름</label
        >
        <div class="grid grid-cols-6 gap-4">
          <input
            type="text"
            id="name"
            class="h-13 col-span-4 bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-2"
      ...
      <div id="email" class="mt-8">
        <label for="email" class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >이메일</label
        >
        <div class="grid grid-cols-6 gap-4">
          <div class="col-span-4">
            <input
              type="email"
              id="email"
              class="h-13 bg-gray-50 border border-gray-300 text-gray-900 text-xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div id="password" class="mt-8">
        <label for="password" class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >비밀번호</label
        >
        <div class="grid grid-cols-6 gap-4">
          <div class="col-span-4">
      ...
      <div id="passwordCheck" class="mt-8">
        <label
          for="passwordCheck"
          class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >비밀번호 확인</label
        >
        <div class="grid grid-cols-6 gap-4">
          <div class="col-span-4">
      ...
      <div id="phone" class="mt-8">
        <label for="phone" class="block mb-2 text-xl text-gray-900 dark:text-white font-semibold"
          >전화번호</label
        >
        <div class="grid grid-cols-6 gap-4">
          <div class="col-span-4">
