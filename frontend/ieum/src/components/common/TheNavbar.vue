<template>
  <nav class="bg-white shadow-md rounded-md">
    <div class="w-full flex flex-wrap items-center justify-between mx-auto p-4">
      <div class="flex">
        <router-link :to="{ name: 'TheMainViewVue' }" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="@/assets/images/logo.png" class="h-16" alt="Flowbite Logo" />
        </router-link>
        <div v-show="!hide" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
          id="navbar-user">
          <ul
            class="flex flex-col font-bold p-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
              <router-link :to="{ name: 'TheChatView' }"
                class="menu-block text-black rounded md:bg-transparent md:text-green-500 md:p-0 md:hover:text-green-600">대화목록
              </router-link>
            </li>
            <li>
              <a href="/carecheck"
            ...
            <li>
              <a href="#"
                class="menu-block text-black rounded md:bg-transparent md:text-green-500 md:p-0 md:hover:text-green-600">일정</a>
            </li>
            <li>
              <!-- Main modal -->
              <VModal></VModal>
      ...
      <div v-show="!hide" class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse mr-5">
        <button type="button"
