  ...
  <div class="content-container p-6 flex flex-col space-y-4">
    ...
    <div class="major-c time-input row mb-4">
      ...
      <div class="row d-flex align-items-center">
        ...
        <div class="col-8 d-flex">
          <select v-model="selectedNumber" id="numberSelect1" class="p-2 border rounded bg-gray-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 p-2.5 dark:bg-gray-400 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-400 dark:focus:border-gray-400">
    ...
    <div class="major-c time-input row">
      ...
      <div class="row d-flex align-items-center  mb-4">
        <div class="col-8 d-flex">
          <select v-model="selectedNumber3" id="numberSelect3" class="p-2 border rounded bg-gray-10 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 p-2.5 dark:bg-gray-400 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-400 dark:focus:border-gray-400">
            <option v-for="num in numbers3" :key="num" :value="num">{{ num }}</option>
          </select>
          <span class="ml-2 mr-2">시</span>
          <select v-model="selectedNumber4" id="numberSelect4" class="p-2 border rounded bg-gray-10 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 p-2.5 dark:bg-gray-400 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-400 dark:focus:border-gray-400">
