<template>
  <div class="all mt-40 mb-40 ml-80 mr-80">
    ...
    <div id="password" class="mt-6 grid grid-cols-2 gap-4">
      <div>
        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">비밀번호/Password</label>
    ...
    <div id="policy" class="items-start mt-6 flex justify-center">
      ...
      <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">가입 시,
