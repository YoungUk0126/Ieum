    ...
    <div id="all" class="flex justify-center">
        <div id=grid class="grid grid-cols-9 gap-4 mb-96 mt-64">
            ...
            <div id="profile" class="col-span-3 w-60">
                ...
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-model="careInfo.careName" disabled>
            ...
            <div id="profile2" class="col-span-3 w-60">
                ...
                <input type="text"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-model="careInfo.careBirth" @input="checkBirthFunction">
...
const updateInfo = () => {
    if (checkPhone.value && checkbirth.value) {
        updateCareInfo()
        updateSerialNumber()
    }
    else {
...
const checkBirthFunction = () => {
    const validateBirth = /^(?:19|20)\d\d-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\d|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)$/;
    checkbirth.value = !validateBirth.test(careInfo.value.careBirth)
